      ...
      <nav className="bg-white/80 backdrop-blur-md sticky top-0 z-50 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div className="h-10 w-[1px] bg-gray-100 hidden md:block mx-4"></div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-10 w-full space-y-10">
        ...
        <div className="grid lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1 space-y-8">
            <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-2xl shadow-emerald-900/5">
              ...
              <div className="space-y-4">
                {['all', 'pending', 'submitted', 'confirmed', 'rejected', 'hold', 'history'].map(s => (
                  <button
                    key={s}
                    onClick={() => setFilter(s)}
                    className={`w-full text-left p-4 rounded-2xl border-2 transition-all font-black text-xs uppercase tracking-widest ${filter === s
            ...
            <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-2xl shadow-emerald-900/5 space-y-4">
